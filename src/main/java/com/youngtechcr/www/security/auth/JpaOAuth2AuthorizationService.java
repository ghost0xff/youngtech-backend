...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        Optional<AuthAuthorization> result;
        if (tokenType == null) {
    ...
    private OAuth2Authorization toObject(AuthAuthorization entity) {
    ...
    private AuthAuthorization toEntity(OAuth2Authorization authorization) {
        AuthAuthorization entity = new AuthAuthorization();
