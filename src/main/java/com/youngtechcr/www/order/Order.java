...
public void setOrid_shopping_cartderedProductsList(List<OrderedProduct> orderedProductsList) {
...
public boolean equals(Object o) {
    ...
    Order order = (Order) o;
    return Float.compare(order.total, total) == 0 && Float.compare(order.subtotal, subtotal) == 0 && ivaPercentage == order.ivaPercentage && isDelivered == order.isDelivered && isCanceled == order.isCanceled && Objects.equals(orderId, order.orderId) && Objects.equals(orderDate, order.orderDate) && Objects.equals(deliveryDate, order.deliveryDate) && Objects.equals(createdAt, order.createdAt) && Objects.equals(updatedAt, order.updatedAt) && Objects.equals(customer, order.customer) && Objects.equals(orderedProductsList, order.orderedProductsList);
}

@Override
public int hashCode() {
    return Objects.hash(orderId, total, subtotal, ivaPercentage, isDelivered, isCanceled, orderDate, deliveryDate, createdAt, updatedAt, customer, orderedProductsList);
}
